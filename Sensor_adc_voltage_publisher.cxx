...
extern "C" int publisher_main(int domainId, int sample_count)
{
    ...
    double val = 0;
    char mystring [100];
    FILE *AnalogRead1 = NULL;
    static const char* const ain1  = "/sys/devices/platform/tsc/ain1";

    /* To customize participant QoS, use 
       the configuration file USER_QOS_PROFILES.xml */
    participant = DDSTheParticipantFactory->create_participant_with_profile(
        domainId, "DocBox_Library","dim15_MDPnP_Profile",
...
*/
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        //	printf("Writing SensorADCVoltage, count %d\n", count);
            AnalogRead1 = fopen(ain1, "r");

            if (AnalogRead1 == NULL)
                    perror ("Error opening Analog Ports");
            else{
                 fgets (mystring , 100 , AnalogRead1);
                 val = atof(mystring);
                 instance->value = val;

            }
            strcpy(instance->usi,"Pulse ");
